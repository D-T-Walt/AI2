...
document.addEventListener('DOMContentLoaded', function (){
    ...
    addToCartButtons.forEach(button=>{
        button.addEventListener('click', function (){
            ...
            if (index !== -1){
                ...
                //Push new info if the item wasn't there before
    ...
    //Cart Cancel button functionality
    ...
    //Cart Exit button functionality
    ...
    exitButton.addEventListener('click', function (){
        if (productNames.length=== 0){
            ...
            if (confirm("Are you sure you want to exit?\nYOU WILL HAVE TO RELOGIN AND SELECT YOUR ITEMS AGAIN")){
                window.location.href= '../HTML/index.html'; //Redirect to home page
            } 
    });
});
...
function exitInvoice(){
    if (confirm("Are you sure you want to exit?\nYOU WILL HAVE TO RELOGIN AND SELECT ITEMS AGAIN IF THE INVOICE IS POPULATED")){
        localStorage.removeItem('productNames');
        localStorage.removeItem('productPrices');
        localStorage.removeItem('productQuantities');
