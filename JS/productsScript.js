...
const userCart= registrationData[userIndex]?.cart || []; //store the cart of the current loggeduser in usercart

//Array of prducts objects
//2.a.i. Create an array of product objects in JavaScript. 
const allProducts= [
...
document.addEventListener('DOMContentLoaded', function (){
    ...
    // Add to Cart functionality
     ...
     //2.e. Display the product list dynamically on the website
